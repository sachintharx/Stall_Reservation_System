    ...
    <div className={`min-h-screen bg-gradient-to-br from-[#1a1f37] via-[#2d1b4e] to-[#1a1f37] flex items-center justify-center p-8 transition-opacity duration-500 ${fadeIn ? 'opacity-100' : 'opacity-0'} relative overflow-hidden`}>
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Vendor Portal Card */}
          <button
            onClick={() => setCurrentView('vendor_register')}
          ...
          <button
            ...
            className="group relative bg-gradient-to-br from-[#2a2f4a]/80 to-[#1e2337]/80 backdrop-blur-xl p-8 rounded-3xl border border-white/10 shadow-2xl hover:shadow-blue-500/30 transform hover:scale-105 transition-all duration-300 hover:border-blue-500/40 overflow-hidden"
          >
            {/* Animated background gradient */}
            ...
            <div className="relative flex flex-col items-center space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-300 text-center mb-4">Admin dashboard for managing reservations</p>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setVendorInfo({ ...vendorInfo, password: e.target.value })}
                  className="w-full pl-10 pr-4 py-3 bg-[#1a1f37]/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500/50 transition text-white placeholder-gray-500"
